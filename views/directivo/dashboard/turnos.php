...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton--panel" href="/directivo/turnos/añadir">
    ...
    <?php if( !empty($turnos)) { ?>
        <table class="table">
            ...
            <tbody class="table__tbody">
                <?php foreach($turnos as $miembro) { ?>
                    <tr class="table__tr">
                        <td class="table__td" data-label="Nombre">
                            <?php echo $miembro->nombre; ?>
                        </td>
                        <td class="table__td--acciones">
                            <a class="table__accion table__accion--editar" href="/directivo/turnos/editar?id=<?php echo $miembro->id; ?>">
                                <i class="fa-solid fa-user-pen"></i>
                                
                            </a>
                            <form method="POST" action="/directivo/turnos/eliminar" class="table__formulario">
