...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton--panel" href="/colaborador/dashboard/lista_fem">
    <!-- <i class="fa-solid fa-file-circle-check"></i> -->
    <i class="fa-solid fa-sheet-plastic"></i>
        Femenino
    </a>
    <a class="dashboard__boton--panel" href="/colaborador/dashboard/lista_playa">
        <i class="fa-solid fa-umbrella-beach"></i>
        Playa
    </a>
</div>

<form id="form-asistencia" method="POST" action="/colaborador/dashboard" enctype="multipart/form-data">
    <?php include_once __DIR__ . '/../../templates/alertas.php'; ?>

    <div id="filtros" class="dashboard__filtros">
        <h3 id="filtro_ppal" class="grid-item-full">Filtros:</h3>
        <div id="b_pack" class="dashboard__inputs dashboard__inputs--text grid-item-row2-col1 ">
            <h4>Modalidad:</h4>
            <div class="dashboard__campo">
                <select class="dashboard__campo" name="filtroModalidad" id="FiltroModalidad">
        ...
        <div id="b_pack" class="dashboard__inputs dashboard__inputs--text grid-item-row2-col2 ">
            <h4>Categoría:</h4>
            <div class="dashboard__campo">
                <select class="dashboard__campo" name="filtroCategoria" id="filtroCate">
                    <option selected value="">Ver todos</option>
                    <!-- Las opciones de categoría se agregarán dinámicamente -->
                </select>
            </div>
        </div>
        <div id="lista_nombre" class="dashboard__inputs dashboard__inputs--text grid-item-row3-col1">
            <h4>Fecha:</h4>
            <div class="dashboard__campo">
                <input id="fecha" type="date" name="fecha" />
            </div>
        </div>
        <div id="b_tipo" class="dashboard__inputs dashboard__inputs--text grid-item-row3-col2 ">
            <h4>Turno:</h4>
            <div class="dashboard__campo">
        ...
        <button id="restablecerFiltrosLista" class="dashboard__boton--panel ">
