...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton--panel" href="/directivo/dashboard/futsal">
...
<div class="dashboard__formulario">
    ...
    <form method="POST" action="/directivo/futsal/añadir" enctype="multipart/form-data" class="formulario">
