...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton--panel" href="/directivo/lista/lista_fem">
    <!-- <i class="fa-solid fa-file-circle-check"></i> -->
    <i class="fa-solid fa-sheet-plastic"></i>
        Femenino
    </a>
    <a class="dashboard__boton--panel" href="/directivo/lista/lista_playa">
...
<form id="form-asistencia" method="POST" action="/directivo/lista" enctype="multipart/form-data">
