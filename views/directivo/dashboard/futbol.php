...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton--panel" href="/directivo/futbol/añadir">
                ...
                <?php foreach($arbitros as $miembro) { ?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td--acciones">
                            <a class="table__accion table__accion--editar" href="/directivo/futbol/editar?id=<?php echo $miembro->id; ?>">
                                <i class="fa-solid fa-user-pen"></i>
                                
                            </a>
                            <form method="POST" action="/directivo/futbol/eliminar" class="table__formulario">
