...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton--panel" href="/directivo/modalidades/añadir">
    ...
    <?php if( !empty($modalidades)) { ?>
        <table class="table">
            ...
            <tbody class="table__tbody">
                <?php foreach($modalidades as $miembro) { ?>
                    <tr class="table__tr">
                        <td class="table__td" data-label="Nombre">
                            <?php echo $miembro->nombre; ?>
                        </td>
                        <td class="table__td--acciones">
                            <a class="table__accion table__accion--editar" href="/directivo/modalidades/editar?id=<?php echo $miembro->id; ?>">
                                <i class="fa-solid fa-user-pen"></i>
                                
                            </a>
                            <form method="POST" action="/directivo/modalidades/eliminar" class="table__formulario">
